...
export const HOOK_OPENERS = {
  ...
  tiktok: [
    '기도가 안 나오는 밤이 있습니다.',
    '가장 깊은 곳에서 드린 기도였습니다.',
    '무너진 자리에서 처음으로 노래가 나왔습니다.',
    '말이 사라진 자리에, 노래가 남았습니다.',
  ],
  // YouTube 설명 인트로(앞 157자) — 감성 2~3줄
  youtube: [
    '무너진 자리에서야 비로소 들리는 노래가 있습니다.',
    '가장 낮은 곳에서 드린 기도가, 가장 먼저 닿았습니다.',
    '벼랑 끝에서야 우리는 그분의 목소리를 듣습니다.',
  ],
  // Instagram 후킹(앞 125자)
  instagram: [
    '가장 깊이 가라앉은 자리에서 드린 기도였습니다.',
